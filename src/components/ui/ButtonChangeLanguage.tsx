...
export default function ButtonChangeLanguage() {
  ...
  const handleChangeLanguage = () => {
    ...
    safeSetLocalStorage("LANGUAGE", newLanguage);
  };

  useEffect(() => {
    const languageStorage = safeGetLocalStorage("LANGUAGE");
  ...
  return (
    <>
      <button
        ...
        className={`flex items-center cursor-pointer transition-transform duration-500 border border-foreground rounded-full p-2 ${isEnglish ? "rotate-360" : "rotate-0"
          }`}
      >
